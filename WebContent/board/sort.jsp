...
<body>
	<div class="btn-group">
		...
		<ul class="dropdown-menu" role="menu">
			<li><a href="boardList.do?page=${page}&sort=readCount">조회수&nbsp;&nbsp;&nbsp;&nabla;</a></li>
			<li class="dropMenu"><a href="boardList.do?page=${page}&sort=replyCount">댓글수&nbsp;&nbsp;&nbsp;&nabla;</a></li>
			<li class="divider"></li>
			<li class="dropMenu"><a href="boardList.do?page=${page}">원래대로</a></li>
		</ul>
	</div>
