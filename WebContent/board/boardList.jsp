			...
			<div class="col-md-11">
				<div class="form-group pull-right">
					<form action="boardList.do?page=${page }&sort=searchPro" method="post" class="form-inline">
						...
						<input style="width: 260px" type="text" class="form-control" name="search" id="search" autofocus placeholder="검색어를 입력하세요(내용, 제목, 글쓴이)" />
						<button class="btn btn-danger pull-right" type="submit">찾기</button>
					</form>
				</div>
			</div>
		</div>
